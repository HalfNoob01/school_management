...
const Announcement = async () => {
  ...
  return (
    <div className="bg-white p-4 rounded-md">
       ...
       {data[0] &&  <div className="bg-mainSkyLight rounded-md p-4">
               <div className="flex items-center justify-between">
        ...
        {data[1] && <div className="bg-mainPurpleLight rounded-md p-4">
               <div className="flex items-center justify-between">
        ...
        {data[2] && <div className="bg-mainYellowLight rounded-md p-4">
               <div className="flex items-center justify-between">
