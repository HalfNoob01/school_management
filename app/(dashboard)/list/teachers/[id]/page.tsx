    ...
    sex : "male"
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
           <Link className="p-3 rounded-md bg-mainSkyLight" href="/">Teacher&apos;s Classes</Link>
           <Link className="p-3 rounded-md bg-mainPurpleLight" href="/">Teacher&apos;s Students</Link>
           <Link className="p-3 rounded-md bg-mainYellowLight" href="/">Teacher&apos;s Lessons</Link>
           <Link className="p-3 rounded-md bg-pink-50" href="/">Teacher&apos;s Exams</Link>
           <Link className="p-3 rounded-md bg-mainSkyLight" href="/">Teacher&apos;s Assignments</Link>
        </div>
      </div>
      <Performance/>
      <Announcement />
