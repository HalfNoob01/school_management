    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
      ...
      {/* User Info Card */}
         <div className="bg-mainSky px-6 py-4 rounded-md flex-1  flex gap-4">
          ...
          <div className="w-2/3 flex flex-col justify-between gap-4">
           <h1 className="text-xl font-semibold">Sasha Gray</h1>
      ...
      <div className="bg-white p-4 rounded-md">
        ...
        <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
           <Link className="p-3 rounded-md bg-mainSkyLight" href="/">Student&apos;s Lessons</Link>
           <Link className="p-3 rounded-md bg-mainPurpleLight" href="/">Student&apos;s Teachers</Link>
           <Link className="p-3 rounded-md bg-mainYellowLight" href="/">Student&apos;s Results</Link>
           <Link className="p-3 rounded-md bg-pink-50" href="/">Student&apos;s Exams</Link>
           <Link className="p-3 rounded-md bg-mainSkyLight" href="/">Student&apos;s Assignments</Link>
        </div>
      </div>
      <Performance/>
      <Announcement />
