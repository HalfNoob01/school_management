...
export default function Home() {
  ...
  return (
    <div className='h-screen flex items-center justify-center bg-mainSkyLight '>
      <SignIn.Root >
          <SignIn.Step name='start' className='bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2'>
            ...
            <Clerk.Field name="password" className='flex flex-col gap-2'>
              ...
              <SignIn.Action submit className='bg-blue-500 text-white my-2 rounded-md text-sm p-[10px]'>Sign In</SignIn.Action>
